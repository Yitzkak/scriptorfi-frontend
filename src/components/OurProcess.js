  ...
  return (
    <div className="bg-gray-50 py-16 px-6 mt-10 text-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center space-y-10 md:space-y-0 md:space-x-16">
        ...
        {/* Step 1 - Upload */}
        <div className="flex flex-col items-center bg-white text-center shadow-lg rounded-lg p-8 md:p-4">
        ...
        <div className="flex flex-col items-center bg-white text-center shadow-lg rounded-lg p-8 md:4">
