...
const Hero = () => {
  return (
    <div className="bg-[#0FFCBE] flex flex-col items-center justify-center text-center py-16 px-4 md:py-24 md:px-10 lg:px-20">
      ...
      UNLEASH YOUR CONTENT'S POTENTIAL BY TRANSCRIBING WITH SCRIPTOR-Fi
      </h5>
      
      <p className="text-base text-black max-w-lg mt-4 mb-6 md:text-lg lg:text-xl">
      Powered by AI, Perfected by Humans. Scriptor-Fi delivers quick, accurate transcription with expert human oversight
      </p>
